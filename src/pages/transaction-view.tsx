      ...
      <PageToolbar
        ...
        description={
          <span className="inline-flex flex-wrap items-center gap-2">
            ...
            <Badge variant={statusVariant(transaction.statusLabel)}>{transaction.statusLabel || '-'}</Badge>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <p className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant={statusVariant(transaction.statusLabel)}>
                ...
                <tbody>
                  {transaction.linkedRefunds?.map((refund) => (
                    <tr key={refund.id} className="border-t border-border/60">
                      ...
                      <td className="py-1.5 pr-3">
                        <Badge variant={statusVariant(refund.statusLabel)}>
